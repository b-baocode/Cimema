...
namespace MV.ApplicationLayer.Library
{
    public class VnPayLibrary
    {
        ...
        public PaymentInformationResponse GetFullResponseData(IQueryCollection collection, string hashSecret)
        {
        ...
        public string CreateRequestUrl(string baseUrl, string vnpHashSecret)
        {
            ...
            var secureHash = HmacSha512(vnpHashSecret, signData).ToLower();
