...
namespace MV.ApplicationLayer.RepositoryInterfaces
{
    public interface IMovieRepository
    {
        ...
        Task<IEnumerable<Movie>> GetMoviesByCustomerCriteriaAsync(string? title, string? poster, string? actors, DateOnly? publishDate, int skip, int take);
        Task<int> GetTotalMoviesByCustomerCriteriaAsync(string? title, string? poster, string? actors, DateOnly? publishDate);
